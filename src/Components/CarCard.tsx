...
const CarCard = ({
  ...
  return (
    <div className="bg-white p-6 rounded-md m-2">
      <div className="flex flex-col">
        <div className="flex">
          <div className="flex flex-grow justify-start items-start text-gray-900 font-sans text-lg font-bold">
            {carName}
          </div>
          <div className="flex flex-grow justify-end items-end">
            ...
            >
              <g clip-path="url(#clip0_2997_234)">
                <path
        ...
        <div className="text-gray-600 font-sans text-base font-normal mt-1">
          {carType}
        </div>
        ...
        <div className="my-5">
          <img
            ...
            src={
              "https://www.motortrend.com/uploads/2023/04/2024-BMW-i7-M70-xDrive-Electric-Vehicle-Luxury-Sedan-M-Sport-6.jpg?fit=around%7C875:492.1875"
            }
          ></img>
        </div>
        <div className="flex">
          <div className="flex flex-grow justify-start items-start gap-4">
            <div className="flex gap-1">
              ...
              <div className="text-gray-600 font-sans text-lg font-normal">
                {capacity}
              </div>
            </div>
            <div className="flex gap-1">
          ...
          <div className="flex flex-grow justify-end items-end">
            <div className="text-gray-900 font-sans font-medium text-lg">
              ${rent}
              <span className="text-gray-600 font-sans text-lg font-normal">
                /d
              </span>
            </div>
          </div>
